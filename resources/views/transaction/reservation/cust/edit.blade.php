...
@endsection
@section('content')
    @include('transaction.reservation.cust.custprogressbar')
            ...
            <div class="col-lg-12">
                <div class="card shadow-sm border">
                    ...
                    <div class="card-body p-3">
                        <form class="row g-3" method="POST" action="{{ route('transaction.reservation.cust.updateCustomer', ['customer' => $customer->id]) }}"
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="date" class="form-control @error('birthdate') is-invalid @enderror"
                                    id="birthdate" name="birthdate" value="{{ old('birthdate', $customer->birthdate) }}">
                                @error('birthdate')
                                    <div class="text-danger mt-1">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <select class="form-select @error('gender') is-invalid @enderror" id="gender" name="gender" aria-label="Default select example">
                                    <option value="" {{ old('gender', $customer->gender) === '' ? 'selected' : '' }} selected>Select Gender</option>
