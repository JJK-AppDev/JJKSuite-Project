...
class RoomStatusSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $informations = [
            ...
            'A room that is being occupied by someone legally and registered as a hotel guest in a dirty room. This happened due to a change in status from OC to OD after one night stay.',
            ...
            'Rooms that put this sign mean guests dont want to be disturbed.',
