                        ...
                        <div class="single-post row">
                            <div class="col-lg-12">
                                <div class="feature-img">
                                    <img class="img-fluid" src="img/userviewimg/blog/feature-img1.jpg" alt="">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <img class="img-fluid" src="img/userviewimg/blog/post-img1.jpg" alt="">
                                    </div>
                                    <div class="col-6">
                                        <img class="img-fluid" src="img/userviewimg/blog/post-img2.jpg" alt="">
                                    </div>
                        ...
                        <div class="navigation-area">
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-12 nav-left flex-row d-flex justify-content-start align-items-center">
                                    <div class="thumb">
                                        <a href="#"><img class="img-fluid" src="img/userviewimg/blog/prev.jpg" alt=""></a>
                                    </div>
                                    <div class="arrow">
                                ...
                                <div class="col-lg-6 col-md-6 col-12 nav-right flex-row d-flex justify-content-end align-items-center">
                                    ...
                                    <div class="thumb">
                                        <a href="#"><img class="img-fluid" src="img/userviewimg/blog/next.jpg" alt=""></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="comments-area">
                            ...
                            <div class="comment-list">
                                <div class="single-comment justify-content-between d-flex">
                                    <div class="user justify-content-between d-flex">
                                        <div class="thumb">
                                            <img src="img/userviewimg/blog/c1.jpg" alt="">
                                        </div>
                                        <div class="desc">
                            ...
                            <div class="comment-list left-padding">
                                <div class="single-comment justify-content-between d-flex">
                                    <div class="user justify-content-between d-flex">
                                        <div class="thumb">
                                            <img src="img/userviewimg/blog/c2.jpg" alt="">
                                        </div>
                                        <div class="desc">
                            ...
                            <div class="comment-list left-padding">
                                <div class="single-comment justify-content-between d-flex">
                                    <div class="user justify-content-between d-flex">
                                        <div class="thumb">
                                            <img src="img/userviewimg/blog/c3.jpg" alt="">
                                        </div>
                                        <div class="desc">
                            ...
                            <div class="comment-list">
                                <div class="single-comment justify-content-between d-flex">
                                    <div class="user justify-content-between d-flex">
                                        <div class="thumb">
                                            <img src="img/userviewimg/blog/c4.jpg" alt="">
                                        </div>
                                        <div class="desc">
                            ...
                            <div class="comment-list">
                                <div class="single-comment justify-content-between d-flex">
                                    <div class="user justify-content-between d-flex">
                                        <div class="thumb">
                                            <img src="img/userviewimg/blog/c5.jpg" alt="">
                                        </div>
                                        <div class="desc">
                    ...
                    <div class="col-lg-4">
                        <div class="blog_right_sidebar">
                            ...
                            <aside class="single_sidebar_widget author_widget">
                                <img class="author_img rounded-circle" src="img/userviewimg/blog/author.png" alt="">
                            ...
                            <aside class="single_sidebar_widget popular_post_widget">
                                ...
                                <div class="media post_item">
                                    <img src="img/userviewimg/blog/post1.jpg" alt="post">
                                ...
                                <div class="media post_item">
                                    <img src="img/userviewimg/blog/post2.jpg" alt="post">
                                    <div class="media-body">
                                ...
                                <div class="media post_item">
                                    <img src="img/userviewimg/blog/post3.jpg" alt="post">
                                    <div class="media-body">
                                ...
                                <div class="media post_item">
                                    <img src="img/userviewimg/blog/post4.jpg" alt="post">
                                    <div class="media-body">
                            ...
                            <aside class="single_sidebar_widget ads_widget">
                                <a href="#"><img class="img-fluid" src="img/userviewimg/blog/add.jpg" alt=""></a>
                                <div class="br"></div>
                            </aside>
