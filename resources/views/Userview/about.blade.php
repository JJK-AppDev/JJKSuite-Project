<html lang="en">
    <head>
        ...
        <link rel="icon" href="img/userviewimg/favicon.png" type="img/userviewimg/png">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-footer-widget instafeed">
                            ...
                            <ul class="list_style instafeed d-flex flex-wrap">
                                <li><img src="img/userviewimg/instagram/Image-01.jpg" alt=""></li>
                                <li><img src="img/userviewimg/instagram/Image-02.jpg" alt=""></li>
                                <li><img src="img/userviewimg/instagram/Image-03.jpg" alt=""></li>
                                <li><img src="img/userviewimg/instagram/Image-04.jpg" alt=""></li>
                                <li><img src="img/userviewimg/instagram/Image-05.jpg" alt=""></li>
                                <li><img src="img/userviewimg/instagram/Image-06.jpg" alt=""></li>
                                <li><img src="img/userviewimg/instagram/Image-07.jpg" alt=""></li>
                                <li><img src="img/userviewimg/instagram/Image-08.jpg" alt=""></li>
                            </ul>
                        </div>
                    </div>						
                </div>
