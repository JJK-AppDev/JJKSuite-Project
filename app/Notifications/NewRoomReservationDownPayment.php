...
class NewRoomReservationDownPayment extends Notification
{
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ...
            ->line('Payment: ' . Helper::convertToRinggit($this->payment->price))
    ...
    {
        return [
            'message' => 'Room ' . $this->transaction->room->number . ' reservated by ' . $this->transaction->customer->name . '. Payment: ' . Helper::convertToRinggit($this->payment->price),
