                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="categories_post">
                            <img src="img/userviewimg/blog/cat-post/cat-post-3.jpg" alt="post">
                    ...
                    <div class="col-lg-4">
                        <div class="categories_post">
                            <img src="img/userviewimg/blog/cat-post/cat-post-2.jpg" alt="post">
                            <div class="categories_details">
                                <div class="categories_text">
                    ...
                    <div class="col-lg-4">
                        <div class="categories_post">
                            <img src="img/userviewimg/blog/cat-post/cat-post-1.jpg" alt="post">
                            <div class="categories_details">
                                <div class="categories_text">
                        ...
                        <div class="blog_left_sidebar">
                            <article class="row blog_item">
                               <div class="col-md-3">
                                ...
                                <div class="col-md-9">
                                    <div class="blog_post">
                                        <img src="img/userviewimg/blog/main-blog/m-blog-1.jpg" alt="">
                            ...
                            <article class="row blog_item">
                               <div class="col-md-3">
                                ...
                                <div class="col-md-9">
                                    <div class="blog_post">
                                        <img src="img/userviewimg/blog/main-blog/m-blog-2.jpg" alt="">
                                        <div class="blog_details">
                            ...
                            <article class="row blog_item">
                               <div class="col-md-3">
                                ...
                                <div class="col-md-9">
                                    <div class="blog_post">
                                        <img src="img/userviewimg/blog/main-blog/m-blog-3.jpg" alt="">
                                        <div class="blog_details">
                            ...
                            <article class="row blog_item">
                               <div class="col-md-3">
                                ...
                                <div class="col-md-9">
                                    <div class="blog_post">
                                        <img src="img/userviewimg/blog/main-blog/m-blog-4.jpg" alt="">
                                        <div class="blog_details">
                            ...
                            <article class="row blog_item">
                               <div class="col-md-3">
                                ...
                                <div class="col-md-9">
                                    <div class="blog_post">
                                        <img src="img/userviewimg/blog/main-blog/m-blog-5.jpg" alt="">
                                        <div class="blog_details">
                    ...
                    <div class="col-lg-4">
                        <div class="blog_right_sidebar">
                            ...
                            <aside class="single_sidebar_widget author_widget">
                                <img class="author_img rounded-circle" src="{{ asset('/img/userviewimg/blog/author.png')}}" alt="">
                            ...
                            <aside class="single_sidebar_widget popular_post_widget">
                                ...
                                <div class="media post_item">
                                    <img src="{{ asset('/img/userviewimg/blog/post1.jpg')}}" alt="post">
                                ...
                                <div class="media post_item">
                                    <img src="{{ asset('/img/userviewimg/blog/post2.jpg')}}" alt="post">
                                    <div class="media-body">
                                ...
                                <div class="media post_item">
                                    <img src="{{ asset('/img/userviewimg/blog/post3.jpg')}}" alt="post">
                                    <div class="media-body">
                                ...
                                <div class="media post_item">
                                    <img src="{{ asset('/img/userviewimg/blog/post4.jpg')}}" alt="post">
                                    <div class="media-body">
                            ...
                            <a href="#"><img class="img-fluid" src="{{ asset('/img/userviewimg/blog/add.jpg')}}" alt=""></a>
                                <div class="br"></div>
                            </aside>
