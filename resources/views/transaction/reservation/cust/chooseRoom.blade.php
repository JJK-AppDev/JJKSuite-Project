            ...
            <div class="col-md-8 mt-2">
                <div class="card shadow-sm border">
                    <div class="card-body p-3">
                        ...
                        <hr>
                        <form method="GET"
                            action="{{ route('transaction.reservation.cust.chooseRoom', ['customer' => $customer->id]) }}">
                            <div class="row mb-2">
                                ...
                                <div class="col-lg-12">
                                    <div
                                        ...
                                        <div class="col p-4 d-flex flex-column position-static">
                                            ...
                                            <a href="{{ route('transaction.reservation.cust.confirmation', ['customer' => $customer->id, 'room' => $room->id, 'from' => request()->input('check_in'), 'to' => request()->input('check_out')]) }}"
